...
public class FlowOrganizer {
    ...
    private FlowOrganizer() {
        try {
            ((Dashboard) AppSingle.getInstance().getActivity()).hideKeyboard();
        } catch (Exception e) {
            ((DashboardAdmin) AppSingle.getInstance().getActivity()).hideKeyboard();
        }
    }
    ...
    public void add(Fragment fragment, boolean isToAddBack, Bundle bundle) {
        ...
        try {
            ...
            try {
                fm = ((Dashboard) AppSingle.getInstance().getActivity()).getSupportFragmentManager();
            }catch (Exception e){
                fm = ((DashboardAdmin) AppSingle.getInstance().getActivity()).getSupportFragmentManager();
            }
